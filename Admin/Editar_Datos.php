...
if(isset($_POST["modificar"])) {
  ...
  $sexo = $_POST['campo7'];
   $telefono = $_POST['campo8']; 
    ...
    $contrasena = $_POST['campo10'];



  $sql1 = ("Select * from empleados where idUsuarios = '$id_Cedula'");
  ...
  echo"<form method='post' action='update_datos.php'>
...
<td ><input type = 'text' style='Width:400px' style='text-align:center;'  disabled  value = ".$fila['Correo']."  ></td>
  ...
  <td ><input type = 'text'  style='text-align:center;' disabled   value = ".$fila['Estado_Civil']."  ></td>
   <td ><input type = 'text'  style='text-align:center;' disabled   value = ".$fila['Contrasena']."  ></td>
  ...
  <td><input type='text' name='Var4' value='$edad'   ></td>
  ...
  <td><input type='text' style='Width:400px' name='Var6' value='$direccion'   ></td>
   ...
   <td><input type='text' name='Var7' value='$sexo'   ></td>
     <td><input type='number' name='Var8' value='$telefono'   ></td>
    <td><input type='text' name='Var9' value='$estado_civil'   ></td>
<td><input type='text' name='Var10' value='$contrasena'   ></td>
